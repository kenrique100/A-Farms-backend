...
import com.afarms.investment.exception.ExternalServiceException;
...
public class UserServiceClient {
    ...
    public List<FarmUserDTO> getFarmUsers(String authHeader, UUID farmId) {
        log.debug("Fetching users for farm: {}", farmId);
        try {
            ...
            log.error("Unexpected error fetching farm users for farm {}: {}", farmId, e.getMessage(), e);
            return Collections.emptyList();
        }
    }
